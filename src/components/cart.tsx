...
const Cart = ({
  ...
  const subtotal = products.reduce((acc, elm) => {
    ...
    // Probably need to change this to calc on a price and not casePrice
  ...
  // maybe need to set up a checkbox, to show if its going to a terminal & for a lift gate
  // Also need to update the order type for dynamics
