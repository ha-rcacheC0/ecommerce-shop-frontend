        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-3 text-base-content">Premium Brands</h3>
            ...
            <div className="text-center p-6">
              <div className="text-4xl mb-4">💰</div>
              <h3 className="text-xl font-semibold mb-3 text-base-content">Wholesale Pricing</h3>
              <p className="text-base-content/70">
            ...
            <div className="text-center p-6">
              <div className="text-4xl mb-4">🚚</div>
              <h3 className="text-xl font-semibold mb-3 text-base-content">Fast Shipping</h3>
              <p className="text-base-content/70">
